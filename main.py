...
while launch:
    ...
    if current_player == computer_side:
        ...
        current_player, init_state = Game.computer_turn(
            init_state, current_noeud, current_player, ANN=False, MCTS=False, DEPTH=MINMAX_DEPTH, heuristic=2, MINMAX=True)
        ...
        if human:
            ...
            current_noeud = Node(init_state, current_player,
                                 None, old_player=current_player)
            current_player, init_state = Game.computer_turn(
                init_state, current_noeud, current_player, ANN=False, MCTS=False, DEPTH=MINMAX_DEPTH, heuristic=4, MINMAX=True)
